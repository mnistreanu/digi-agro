...
import {SowingExpenseItemModel} from './sowing-expense-item.model';
import {NumericUtil} from '../../../../common/numericUtil';
import {PinnedRowRendererComponent} from '../../../../modules/aggrid/pinned-row-renderer/pinned-row-renderer.component';
import {ModalService} from '../../../../services/modal.service';

@Component({
    selector: 'app-sowing-expense-item-table',
    templateUrl: './sowing-expense-item-table.component.html',
    styleUrls: ['./sowing-expense-item-table.component.scss']
})
export class SowingExpenseItemTableComponent implements OnInit {

    @Input() models: SowingExpenseItemModel[];
    ...
    currentModel: SowingExpenseItemModel;
    ...
    private setupSummaryRow(models) {
        const summaryRow = new SowingExpenseItemModel();
    ...
    private aggregate(source: SowingExpenseItemModel, item: SowingExpenseItemModel, applyAddition) {
    ...
    public add() {
        const model = new SowingExpenseItemModel();
