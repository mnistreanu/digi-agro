...
import {PesticideExpenseModel} from './pesticide-expense.model';
...
@Component({
    selector: 'app-pesticide-expenses-form',
    templateUrl: './pesticide-expenses-form.component.html',
    styleUrls: ['./pesticide-expenses-form.component.scss']
})
export class PesticideExpensesFormComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder,
                ...
                private pesticideExpenseService: PesticideExpenseService,
    ...
    private setupModel(id) {
        this.pesticideExpenseService.findOne(id).subscribe(model => {
            this.model = model;
    ...
    private prepareNewModel() {
        this.model = new PesticideExpenseModel();
    ...
    save() {
        ...
        this.pesticideExpenseService.save(this.model).subscribe((model) => {
            this.model = model;
    ...
    remove() {
        this.pesticideExpenseService.remove(this.model).subscribe(() => {
