...
import {FertilizerExpenseItemModel} from './fertilizer-expense-item.model';
import {NumericUtil} from '../../../../common/numericUtil';
import {PinnedRowRendererComponent} from '../../../../modules/aggrid/pinned-row-renderer/pinned-row-renderer.component';
import {ModalService} from '../../../../services/modal.service';

@Component({
    selector: 'app-fertilizer-expense-item-table',
    templateUrl: './fertilizer-expense-item-table.component.html',
    styleUrls: ['./fertilizer-expense-item-table.component.scss']
})
export class FertilizerExpenseItemTableComponent implements OnInit {

    @Input() models: FertilizerExpenseItemModel[];
    ...
    currentModel: FertilizerExpenseItemModel;
    ...
    private setupSummaryRow(models) {
        const summaryRow = new FertilizerExpenseItemModel();
    ...
    private aggregate(source: FertilizerExpenseItemModel, item: FertilizerExpenseItemModel, applyAddition) {
    ...
    public add() {
        const model = new FertilizerExpenseItemModel();
