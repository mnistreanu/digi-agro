...
import {WorksExpenseItemModel} from './works-expense-item.model';
import {NumericUtil} from '../../../../common/numericUtil';
import {PinnedRowRendererComponent} from '../../../../modules/aggrid/pinned-row-renderer/pinned-row-renderer.component';
import {ModalService} from '../../../../services/modal.service';

@Component({
    selector: 'app-works-expense-item-table',
    templateUrl: './works-expense-item-table.component.html',
    styleUrls: ['./works-expense-item-table.component.scss']
})
export class WorksExpenseItemTableComponent implements OnInit {

    @Input() models: WorksExpenseItemModel[];
    ...
    currentModel: WorksExpenseItemModel;
    ...
    private setupSummaryRow(models) {
        const summaryRow = new WorksExpenseItemModel();
    ...
    private aggregate(source: WorksExpenseItemModel, item: WorksExpenseItemModel, applyAddition) {
    ...
    public add() {
        const model = new WorksExpenseItemModel();
