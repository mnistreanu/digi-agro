...
// import {ParcelSeasonModel} from './parcel-crop-form/parcel-season.model';
...
@Component({
    selector: 'app-parcel-diagnosis-form',
    templateUrl: './parcel-diagnosis-form.component.html',
    styleUrls: ['./parcel-diagnosis-form.component.scss']
})
export class ParcelDiagnosisFormComponent implements OnInit {
    //
