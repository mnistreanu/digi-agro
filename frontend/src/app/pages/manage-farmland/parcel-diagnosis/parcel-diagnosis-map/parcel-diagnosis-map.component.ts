...
@Component({
    selector: 'app-parcel-diagnosis-map',
    templateUrl: './parcel-diagnosis-map.component.html',
    styleUrls: ['./parcel-diagnosis-map.component.scss']
})
export class ParcelDiagnosisMapComponent implements OnInit {
    ...
    private setupParcel() {
        ...
        if (this.parcelDiagnosisModel.id == null) {
            this.parcelCoordinates = [];
            return;
        }

        const parcelPolygon = new google.maps.Polygon({
            paths: this.parcelDiagnosisModel.paths,
            editable: true,
            draggable: true,
            fillColor: this.getFillColor(),
            fillOpacity: 0.5,
        ...
        this.mapCenter = this.parcelDiagnosisModel.center;
    }
    ...
    public submit() {
        ...
        this.parcelDiagnosisModel.coordinates = this.parcelCoordinates.map((coord) => {
