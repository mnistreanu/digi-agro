...
import {CropPlannerModel} from '../crop-planner.model';
import {ParcelService} from '../../../../services/parcel.service';
import {LangService} from '../../../../services/lang.service';

@Component({
    selector: 'app-crop-planner',
    templateUrl: './crop-planner.component.html',
    styleUrls: ['./crop-planner.component.scss']
})
export class CropPlannerComponent implements OnInit {

    @Output() dataChanged: EventEmitter<CropPlannerModel[]> = new EventEmitter<CropPlannerModel[]>();
    @Output() centerChanged: EventEmitter<any> = new EventEmitter<any>();

    options: GridOptions;
    context;

    models: CropPlannerModel[] = [];
